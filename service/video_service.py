...
from moviepy.editor import AudioFileClip, ImageClip, concatenate_videoclips, TextClip, CompositeVideoClip, CompositeAudioClip, VideoClip, concatenate_audioclips, ColorClip
    ...
    def _validate_inputs(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            for i, segment in enumerate(data["segments"]):
                ...
                if segment["transition"]["type"] not in ["fade", "slide", "zoom", "wipe", "dissolve", "fade_to_black"]:
                    raise ValueError(f"Transition type của segment {i} phải là 'fade', 'slide', 'zoom', 'wipe', 'dissolve' hoặc 'fade_to_black'")
